...
const Mproducto = (props) =>{
    return(
        ...
        {/* Modal Eliminar */}
        <div class="modal fade" id="eliminarp{{id}}"  data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
